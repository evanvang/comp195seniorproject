...
export class PersonService {
  ...
  addPersonDetails(bio: string, certs: string, other: string, projects: string, workexp: string, id: string): void {
  ...
  updatePersonDetails(id: string, dataToUpdate: { bio?: string; certs?: string; other?: string; projects?: string; workexp?: string }): void {
